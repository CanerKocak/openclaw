...
- Compaction: add Morph fast compaction as an alternative provider with onboarding wizard step, `--morph-api-key`/`--skip-morph` CLI flags, and `MORPH_API_KEY` env var auto-detection.
